...
public class AVOSCloud {
  ...
  /**
   * @deprecated Please use {@link AVSMS#requestSMSCode(String, AVSMSOption)}
   */
  ...
  /**
   * @deprecated Please use {@link AVSMS#requestSMSCodeInBackground(String, AVSMSOption, RequestMobileCodeCallback)}
   */
  ...
  /**
   * @deprecated Please use {@link AVSMS#verifySMSCode(String, String)}
   */
  ...
  /**
   * @deprecated Please use {@link AVSMS#verifySMSCodeInBackground(String, String, AVMobilePhoneVerifyCallback)}
   */
